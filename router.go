...
func register(r *gin.Engine) {
	...
	// 专辑管理
	r.GET("/nilmusic/album/all", handler.AllList)					// 获取当前用户全部专辑
	r.POST("/nilmusic/album/create", handler.CreateList)			// 创建专辑
	r.DELETE("/nilmusic/album/delete", handler.DeleteList)		// 删除专辑
	// 专辑音乐操作
